# Outreach Workspace — Sicilia

This directory is the authoritative outreach workspace for the Sicilia territorial campaign of the From-Wildfires-to-Regeneration project. It is the single place where contact management and outreach communications for potential Patrons, Strategic Partners, Introducers, Public Figures, and Organisations in Sicily are created, maintained, and tracked.
...
- **contacts.csv** — The single source of truth for all Sicilia outreach contacts.
- **email-addresses.txt** — Generated from `contacts.csv`. Do not edit manually.
- **master-email.md** — The master outreach email template for the Sicilia campaign.
...
- All future Sicilia contacts are added here only.
